...
export default function Notification() {
  ...
  useEffect(() => {
    ...
    // Cleanup when the component unmounts or when the screen is blurred
    const unsubscribe = navigation.addListener('blur', () => {
      console.log("EEE")
      setNotificationData([]);  // Clear notificationsData when leaving the screen
    });

    // Cleanup on component unmount
    return () => {
      unsubscribe();  // Remove the listener to prevent memory leaks
      setNotificationData([]);  // Clear notificationsData when component unmounts
    };
  }, [navigation]);  // Runs once on component mount and when navigation changes
